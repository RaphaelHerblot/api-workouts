...
const ExerciseForm = ({ chosenExercise, deleteExercise, nbRepetition, onChange }) => ( 
    <div className="exerciseForm">
        ...
        <div className="exercise-informations">
            ...
            <input className="exercise-number" required="required" placeholder="Nombre de répétition" defaultValue={nbRepetition} name="nbRepetition" type="number" min="1" max="99"/>
        </div>
        <div className="button-container-exercices">
            <div className="exercise-button">
                <button type="button" id={"delete_" + chosenExercise.id} onClick={() => deleteExercise(event)} className="btn btn-danger deleteExercise">
